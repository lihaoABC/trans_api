...
# save app from common.print_info()
last_info = None
...
# a fake VideoExtractor object to save app
...
def print_info(site_info=None, title=None, type=None, size=None):
    global last_info
    # create a VideoExtractor and save app for download_urls()
    ve = VideoExtractor()
    last_info = ve
    ve.name = site_info
    ve.title = title
